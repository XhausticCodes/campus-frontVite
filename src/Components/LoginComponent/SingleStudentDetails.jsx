...
const SingleStudentDetails = () => {
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      {/* Header */}
      <div className="bg-gradient-to-r from-pink-500 to-pink-600 text-white rounded-lg shadow-lg p-6 mb-6">
      ...
      <div className="mt-6 text-center">
        <button
          ...
          className="px-6 py-2 bg-pink-600 text-white font-semibold rounded-lg shadow hover:bg-pink-700 transition-colors duration-300"
